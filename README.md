...
## List of Tasks
1. Dissolve 0.1576 g HAuCl₄·3H₂O in 5 mL Nanopure water -- record mass, record vol, qual obs
2. Dissolve \~0.25 g TOAB in 10 mL toluene -- record mass, record vol, qual obs
3. Combine both in a 25 mL tri-neck round-bottom flask. -- qual obv
4. Stir vigorously (\~1100 rpm) for \~15 min. -- qual obv at the end of 15 min
5. Remove the aqueous layer with a 10 mL syringe.
6. Purge with N₂ and cool to 0°C in ice bath over 30 min with stirring.
7. Add 3 eq. PhCH₂CH₂SH (relative to gold). -- calc, record mass
8. Stir slowly; observe color change: deep red → faint yellow (\~5 min) → clear (\~1 hr). - qual obs
9. Increase stir speed and add 10 eq. NaBH₄ in 7 mL ice-cold Nanopure water. - qual obs
10. Stir overnight under N₂ atmosphere.
11. Remove aqueous layer next day with syringe. -- qual obs
12. Dry toluene layer.
13. Add 20 mL ethanol to separate Au₂₅ clusters. -- record vol
